  ...
  return (
    <div className='mx-[15px] md:mx-[100px]  '>
      ...
      <p>
        ...
        nosotros. Esta política de privacidad describe los tipos de información
        personal que recibimos y recopilamos cuando visitas [nombre de la tienda
        online], así como la forma en que utilizamos y protegemos esa
        información. Al visitar [nombre de la tienda online], aceptas los
        términos y condiciones de esta política de privacidad.
      </p>{' '}
      <h2 className='mt-3 text-2xl'>Recopilación de Información</h2>
      <p>
        Cuando visitas [nombre de la tienda online], recopilamos información que
        tu navegador web envía automáticamente, como la dirección de Protocolo
        de Internet (IP), el tipo de navegador, el proveedor de servicios de
        Internet (ISP), las páginas de referencia/salida, el sistema operativo,
        la fecha y hora, y los datos de clics.
      </p>
      <p>
      ...
      <p>
        ...
        nuestros servicios, procesar transacciones, responder a tus consultas y
        comunicarnos contigo. También podemos utilizar tu información para
        ...
        interés. Protección de la Información Implementamos medidas de seguridad
        razonables para proteger la información personal que recopilamos y
        mantenemos. Sin embargo, debes tener en cuenta que ninguna transmisión
        por Internet o almacenamiento electrónico es completamente segura, y no
      ...
      <p>
        ...
        cumplir con la ley, hacer cumplir nuestras políticas o proteger nuestros
      ...
      <p>
        ...
        navegador para que rechace todas las cookies o te avise cuando se envíe
        una cookie. Sin embargo, si no aceptas las cookies, es posible que no
        puedas utilizar algunas partes de nuestro sitio.
      </p>
      ...
      periódicamente esta página para estar al tanto de cualquier cambio. El uso
      continuado de nuestro sitio después de la publicación de cualquier cambio
      en esta política de privacidad constituirá tu aceptación de dichos
      cambios.
